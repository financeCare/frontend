  ...
  void _showEditBudgetDialog(int index) {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text('ปรับวงเงินงบประมาณ: ${item['category']}'),
          content: TextField(
              ...
              onPressed: () {
                ...
                if (newBudget != null && newBudget >= 0) {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('กรุณาป้อนจำนวนเงินที่ถูกต้อง')),
                  );
                }
              },
            ),
        ...
        child: Column(
          ...
          children: [
                ...
                child: Row(
                  ...
                  children: [
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Text('งบประมาณรวมที่ตั้งไว้', style: TextStyle(fontSize: 16, color: Colors.grey)),
                        Text('${totalBudget.toStringAsFixed(2)} บาท',
                            style: const TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.deepPurple)),
                      ],
                    ),
                    const Icon(Icons.pie_chart, size: 40, color: Colors.deepPurple),
                  ],
                ),
              ),
            ),
            ...
            ..._budgetItems.asMap().entries.map((entry) {
              ...
              final Color progressColor = remaining < 0 ? Colors.red : (remaining < (budgeted * 0.2) ? Colors.orange : Colors.lightGreen);
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text('งบที่ตั้ง: ${budgeted.toStringAsFixed(2)} บาท', style: const TextStyle(fontSize: 12, color: Colors.grey)),
                              ],
                            ),
                          ),
                          ...
                          IconButton(
                            ...
                            onPressed: () => _showEditBudgetDialog(index), // **เรียกใช้ฟังก์ชันแก้ไข**
                          ...
                          InkWell(
                            ...
                            child: Padding(
                              ...
                              child: Text(
                                ...
                                style: const TextStyle(fontSize: 12, color: Colors.black87, decoration: TextDecoration.underline),
                              ),
                            ),
                          ),
                          Text(
